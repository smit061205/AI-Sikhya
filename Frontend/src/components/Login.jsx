...
const Login = () => {
  ...
  const handleToggle = () => {
    setCanSee((prev) => !prev);
    // keep focus on input when toggling visibility
    if (passRef.current) {
  ...
  const handleSendOtp = async () => {
    try {
      ...
      setFpLoading(true);
      await axios.post("/user/forgot-password/send-otp", { email: fpEmail });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      setFpLoading(true);
      await axios.put("/user/forgot-password/reset", {
        email: fpEmail,
        otp: fpOtp,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result && result.success) {
        ...
        navigate("/user-Profile"); // Redirect to protected route
      } else {
  ...
  return (
    <div className="min-h-screen bg-black flex justify-center">
      <div className="w-[50%]">
        {!showForgot ? (
          <>
            <h1 className="text-white mt-40 text-5xl text-center">Login</h1>
            {successMsg && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <motion.button
                        ...
                        className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-300 hover:text-cyan-300 transition-colors duration-300 cursor-pointer"
                      >
                        <AnimatePresence mode="wait" initial={false}>
                          <motion.span
